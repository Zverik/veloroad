...
curl -z "data/water-polygons-split-3857.zip" -L -o "data/water-polygons-split-3857.zip" "https://osmdata.openstreetmap.de/download/water-polygons-split-3857.zip"
...
curl -z "data/gmted25.tar.xz" -L -o "data/gmted25.tar.xz" "https://zverik.dev.openstreetmap.org/gmted25.tar.xz"
